...
class LaminaProcesador extends JPanel {
    ...
    public LaminaProcesador() {
        ...
        JButton botonNegrita = new JButton(new ImageIcon(getClass().getResource("negrita.gif")));
        JButton botonCursiva = new JButton(new ImageIcon(getClass().getResource("cursiva.gif")));
        JButton botonSubrayado = new JButton(new ImageIcon(getClass().getResource("subrayado.gif")));
        JButton botonAzulBarra = new JButton(new ImageIcon(getClass().getResource("bola_azul.gif")));
        JButton botonAmarilloBarra = new JButton(new ImageIcon(getClass().getResource("bola_amarilla.gif")));
        JButton botonRojoBarra = new JButton(new ImageIcon(getClass().getResource("bola_roja.gif")));
        JButton botonIzquierda = new JButton(new ImageIcon(getClass().getResource("izquierda.gif")));
        JButton botonCentrar = new JButton(new ImageIcon(getClass().getResource("centrar.gif")));
        JButton botonDerecha = new JButton(new ImageIcon(getClass().getResource("derecha.gif")));
        JButton botonJustificar = new JButton(new ImageIcon(getClass().getResource("justificar.gif")));
        ...
        configurarBarra("src/negrita.gif").addActionListener(new StyledEditorKit.BoldAction());
        configurarBarra("src/cursiva.gif").addActionListener(new StyledEditorKit.ItalicAction());
        configurarBarra("src/subrayado.gif").addActionListener(new StyledEditorKit.UnderlineAction());
        barra.addSeparator();
        configurarBarra("src/bola_azul.gif").addActionListener(
                new StyledEditorKit.ForegroundAction("poner azul",Color.BLUE));
        configurarBarra("src/bola_amarilla.gif").addActionListener(
                new StyledEditorKit.ForegroundAction("poner amarillo",Color.YELLOW));
        configurarBarra("src/bola_roja.gif").addActionListener(
                new StyledEditorKit.ForegroundAction("poner rojo",Color.RED));
        barra.addSeparator();
        configurarBarra("src/izquierda.gif").addActionListener(
                new StyledEditorKit.AlignmentAction("alinear izquierda",0));
        configurarBarra("src/centrar.gif").addActionListener(
                new StyledEditorKit.AlignmentAction("centrar",1));
        configurarBarra("src/derecha.gif").addActionListener(
                new StyledEditorKit.AlignmentAction("alinear derecha",2));
        configurarBarra("src/justificar.gif").addActionListener(
